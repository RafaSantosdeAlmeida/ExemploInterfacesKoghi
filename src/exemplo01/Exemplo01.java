...
public class Exemplo01 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><h1>É PAR?</h1></html>");
        jLabel1.setAlignmentX(0.5F);
        jLabel1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        lblResposta.setText("Digite um número para saber se é par ou ímpar!");

        txtNumero.setToolTipText("Digite apenas números inteiros");
    ...
    private void txtNumeroKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNumeroKeyPressed
        ...
        try {
             if(tecla==java.awt.event.KeyEvent.VK_ENTER){
                ...
                if(num % 2 == 0) {
                    lblResposta.setText("É PAR");
                } else {
                    lblResposta.setText("É IMPAR");
                }
             }
